...
$Ruang = [
 ...
 foreach ($Ruang as $data) {
    ...
    echo "Bangun Ruang: " . $objek->getBangunRuang() . "<br>";
    echo "Sisi: " . $objek->getSisi() . "<br>";
    echo "Jari Jari: " . $objek->getJariJari() . "<br>";
    echo "Tinggi: " . $objek->getTinggi() . "<br>";
    echo "Volume: " . $objek->HitungVolume() . "<br><br>";
 }
?>